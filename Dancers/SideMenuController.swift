...
open class SlideMenuController: UIViewController, UIGestureRecognizerDelegate {
    ...
    open override func closeRight2() {
        guard let _ = rightViewController else { // If rightViewController is nil, then return
            return
        }
    ...
    open override func toggleLeft2() {
        if isLeftOpen() {
            closeLeft()
            setCloseWindowLevel()
    ...
    open override func toggleRight2() {
        if isRightOpen() {
            closeRight()
            setCloseWindowLevel()
...
extension UIViewController {
    ...
    public func slideMenuController2() -> SlideMenuController? {
    ...
    public func toggleLeft2() {
        slideMenuController2()?.toggleLeft()
    }
    
    public func toggleRight2() {
        slideMenuController2()?.toggleRight()
    }
    
    public func openLeft2() {
        slideMenuController2()?.openLeft()
    }
    
    public func openRight2() {
        slideMenuController2()?.openRight()    }
    
    public func closeLeft2() {
        slideMenuController2()?.closeLeft()
    }
    
    public func closeRight2() {
        slideMenuController2()?.closeRight()
    }
    ...
    public func addPriorityToMenuGesuture(_ targetScrollView: UIScrollView) {
        guard let slideController = slideMenuController2(), let recognizers = slideController.view.gestureRecognizers else {
            return
        }
